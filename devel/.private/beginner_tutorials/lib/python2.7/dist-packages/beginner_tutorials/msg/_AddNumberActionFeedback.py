...
"""autogenerated by genpy from beginner_tutorials/AddNumberActionFeedback.msg. Do not edit."""
import sys
...
class AddNumberActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "beginner_tutorials/AddNumberActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','beginner_tutorials/AddNumberFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AddNumberActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = beginner_tutorials.msg.AddNumberFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = beginner_tutorials.msg.AddNumberFeedback()
